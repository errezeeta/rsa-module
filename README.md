...
[![Node.js CI](https://github.com/errezeeta/rsa-module/workflows/build/badge.svg)](https://github.com/errezeeta/rsa-module/actions?query=workflow%3A%22build%22)
[![Coverage Status](https://coveralls.io/repos/github/errezeeta/rsa-module/badge.svg?branch=master)](https://coveralls.io/github/errezeeta/rsa-module?branch=master)
...
`@scbd/rsa` can be imported to your project with `npm`:

```console
npm install @scbd/rsa
```

Then either require (Node.js CJS):

```javascript
const rsa = require('@scbd/rsa')
```

or import (JavaScript ES module):

```javascript
import * as rsa from '@scbd/rsa'
```

The appropriate version for browser or node is automatically exported.

You can also download the [IIFE bundle](https://raw.githubusercontent.com/errezeeta/rsa-module/master/dist/bundles/iife.js), the [ESM bundle](https://raw.githubusercontent.com/errezeeta/rsa-module/master/dist/bundles/esm.min.js) or the [UMD bundle](https://raw.githubusercontent.com/errezeeta/rsa-module/master/dist/bundles/umd.js) and manually add it to your project, or, if you have already installed `@scbd/rsa` in your project, just get the bundles from `node_modules/@scbd/rsa/dist/bundles/`.
